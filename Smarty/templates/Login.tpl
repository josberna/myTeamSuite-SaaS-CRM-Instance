         ...
         <div class="login-box">
			<div class="loginForm">
				...
				<form action="index.php" method="post" name="DetailView" id="form">
					...
					<table class="login" border="0" cellspacing="5" cellpadding="5">
                    <tr>
                    <td><div class="label">User Name</div></td>
                    <td><div class="input"><input type="text" name="user_name"/></div>
                    </tr>
                    <tr>
                    <td><div class="label">Password</div></td>
                    <td><div class="input"><input type="password" name="user_password"/></div></td>
                    </tr>
                    <tr>
                    <td>&nbsp;</td>
                    <td><div class="button">
