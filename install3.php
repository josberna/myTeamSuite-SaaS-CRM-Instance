...
$module->name = 'SFDetail';
$module->label = 'Forecast Detail';
$module->save();
...
$block1->label = 'LBL_SFDETAIL_INFORMATION';
...
$field2->name = 'SFDetailType';
$field2->label = 'Forcast Detail Type'; 
...
$moduleInstance = Vtiger_Module::getInstance('SFDetail');
