   ...
   }else
   {
	   ...
	   if($no_rows > 0 )
	   {
			while($row1 = $adb->fetch_array($result))
			{
			   ...
			   $response .='<td><div style="float:left;">$'.$cWeek[0].'</div><div style="float:right;">$'.$cWeek[1].'</div></td>
							<td><div style="float:left;">$'.$nWeek[0].'</div><div style="float:right;">$'.$nWeek[1].'</div></td>
							<td><div style="float:left;">$'.$Days60[0].'</div><div style="float:right;">$'.$Days60[1].'</div></td>
							<td><div style="float:left;">$'.$Days90[0].'</div><div style="float:right;">$'.$Days90[1].'</div></td>
							<td><div style="float:left;">$'.$Days120[0].'</div><div style="float:right;">$'.$Days120[1].'</div></td>
  						    <td><div style="float:left;">$'.$total[0].'</div><div style="float:right;">$'.$total[1].'</div></td>
							</tr>';
			}
	   }
	   echo $response;
