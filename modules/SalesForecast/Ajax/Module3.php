   ...
   if($no_rows > 0 )
   {
   		while($row1 = $adb->fetch_array($result))
		{
		   $response .='<div style="float:left;height:135px;width:145px;">
		   				<div class="pane2_cell"><strong>'.$row1['name'].'</strong></div>';
		   ...
		   $response .='<div class="pane2_cell" style="text-align:right;">'.$ccount.'$</div>
		   				<div class="pane2_cell" style="text-align:right;">'.$ncount.'$</div>
						<div class="pane2_cell" style="text-align:right;">'.($ccount + $ncount).'$</div>
						</div>';
		}
   }
   echo $response;
