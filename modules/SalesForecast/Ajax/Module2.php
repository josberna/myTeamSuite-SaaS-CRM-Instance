...
function GetMainView2() { 
   ...
   $result=$adb->query("select * from 
   						vtiger_potential,vtiger_account,vtiger_potentialscf
   						where 
						vtiger_account.accountid = vtiger_potential.related_to and vtiger_potential.potentialid = vtiger_potentialscf.potentialid and
			...
			$response .='<tr bgcolor="white"  id="row_pane1_'.$count.'"
							...
							<td 
							 	onmouseover="vtlib_listview.trigger("cell.onmouseover", $(this))" 
	  						    onmouseout="vtlib_listview.trigger("cell.onmouseout", $(this))">'.$row['potentialname'].'</td>
							<td 
								onmouseover="vtlib_listview.trigger(\'cell.onmouseover\', $(this))" 
								onmouseout="vtlib_listview.trigger(\'cell.onmouseout\', $(this))">'.$row['accountname'].'</td>
							<td 
							    onmouseover="vtlib_listview.trigger(\'cell.onmouseover\', $(this))" 
							...
							<td 
							    onmouseover="vtlib_listview.trigger(\'cell.onmouseover\', $(this))" 
							    onmouseout="vtlib_listview.trigger(\'cell.onmouseout\', $(this))">'.ComType($row[$col_name],$row['potentialid']).'</td>
							<td 
							    onmouseover="vtlib_listview.trigger(\'cell.onmouseover\', $(this))" 
...
function ComType($str_return,$pid)
{
	$val = $str_return;
