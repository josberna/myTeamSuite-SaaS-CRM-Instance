...
function get_chart()
{
	...
	$myPicture->setFontProperties(array("FontName"=>"include/pchart/fonts/verdana.ttf","FontSize"=>10));
	$myPicture->drawText(10,17,"Opportunities by Sales Stage",array("R"=>255,"G"=>255,"B"=>255));
	...
	$PieChart->draw3DRing(($width/3) - 10,$height/2,array("WriteValues"=>TRUE,"Border"=>TRUE));
	
	/* Write the legend box */ 
	$PieChart->drawPieLegend(($width/1.5)- 20,$height/3,array("Mode"=>LEGEND_VERTICAL,"Style"=>LEGEND_NOBORDER,"Alpha"=>20));

	$html='<table border="0" align="center"><tr><td><img src="cache/images/pie3D'.$current_user->id.'.png"  /></td></tr></table>';
	
	$myPicture->Render('cache/images/pie3D'.$current_user->id.'.png');
