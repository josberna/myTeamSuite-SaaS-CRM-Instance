...
'LBL_MODULE_APPOINTMENT_DETAIL'=>'Agenda: Detalhe Compromisso',
'LBL_SAVE'=>'Salvar',
'LBL_RESET'=>'Cancelar',
...
'LBL_CALSETTINGS'=>'Configurações Agenda',
...
'LBL_VIEW_DAY_APPNT_INFO' => 'Visualizar Compromisso(s) para este dia',
...
'LBL_RELATEDTO'=>'Relacionado',
'LBL_PENDING'=>'Pendente',
'LBL_PUBLIC'=>'Público',
'LBL_MORE'=>'Mais',
'LBL_EDIT'=>'Editar',
'LBL_EVERYDAY'=>'Todo Dia',
'LBL_EVERYWEEK'=>'Toda Semana',
'LBL_EVERYMON'=>'Todo Mês',
'LBL_WEEKS'=>'Semana(s)',
'LBL_MONTHS'=>'Mês(es)',
'LBL_YEAR'=>'Ano',
'LBL_NONE_SCHEDULED'=>'Nada Agendado',

'LBL_INVITE_INST1'=>'Para convidar, selecione os usuários na lista "Usuários Disponíveis" e clique no botão "Adicionar".',
'LBL_INVITE_SHARE'=>'Para compartilhar, selecione os usuários na lista "Usuários Disponíveis" e clique no botão "Adicionar".',
'LBL_INVITE_INST2'=>'Para remover, selecione os usuários na lista "Usuários Selecionados" e click no botão "Remover".',
'LBL_SELUSR_INFO'=>' Os usuários selecionados receberão um email sobre o Evento.',
...
'LBL_TRACK_EMAIL_BUTTON_TITLE'=>'Rastrear Email [Alt+K]',
'LBL_TRACK_EMAIL_BUTTON_KEY'=>'K',
'LBL_TRACK_EMAIL_BUTTON_LABEL'=>'Rastrear Email',
...
'LBL_LIST_RECURRING_TYPE'=>'Tipo Recorrência',

'ERR_DELETE_RECORD'=>"Um registro deve ser especificado para apagar vtiger_account.",
...
'LBL_EVENTSTAT'=>'Início Evento em',
'LBL_EVENTEDAT'=>'Fim Evento em',
'LBL_INVITE'=>'Convite',
'LBL_REPEAT'=>'Repetir',
'LBL_REMINDER'=>'Lembrete',
'LBL_SENDREMINDER'=>'Enviar Lembrete',
'LBL_NOTIFICATION'=>'Notificação',
'LBL_SENDNOTIFICATION'=>'Enviar Notificação',
'LBL_RMD_ON'=>'Lembrar em',
'LBL_REPEATEVENT'=>'Repetir Evento',
