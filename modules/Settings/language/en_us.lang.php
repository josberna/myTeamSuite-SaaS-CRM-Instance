...
'LBL_NAME_EXAMPLE'=>'(example : John Smith)',
'LBL_EMAIL_EXAMPLE'=>'(example : johnsmith@xyz.com)',
...
'LBL_USER_DESCRIPTION'=>'Manage users who can access myTeamSuite CRM',
...
'LBL_SYSTEM_DESCRIPTION'=>'View myTeamSuite CRM Server details',
...
'LBL_ALLOW'=>'Allows',
'LBL_MESG_VIEW'=>'to view all information / modules of myTeamSuite CRM',
'LBL_MESG_EDIT'=>'to edit all information / modules of myTeamSuite CRM',
...
'Sorry'=>'Sorry',
'uploaded_file_exceeds_maximum_limit'=>'the uploaded file exceeds the maximum myTeamSuite_filesize limit',
...
'VTLIB_LBL_MODULE_MANAGER_DESCRIPTION'=>'Manage module behavior inside myTeamSuite CRM',
...
'LBL_LIST_WORKFLOWS_DESCRIPTION' => 'Create and edit workflows for myTeamsuite',
...
'VTLIB_LBL_PACKAGE_FILE_HELP'=>'myTeamSuite module is packaged as a zip file.',
...
'VTLIB_LBL_REQ_VTIGER_VERSION'=>'Req. myTeamSuite version',
...
'LBL_DEFAULT'=>'By default, SMTP account settings for the outgoing server are configured to od1.myTeamSuite.com mail server. To avoid outgoing emails getting filtered out by spam filters on your recipient ISP mail server, we recommend you implement one of the following.',
...
'LBL_OPTIONS2'=>"Add od1.vtiger.com server as a authorized sender for your domain.<br>
				- If you prefer to retain the myTeamSuite server as the outgoing server, we recommend that you configure your domain's SPF record to include the myTeamSuite server as a valid sender for your domain.
				  For additonal instruction on setting up SPF record, please email od-support@myTeamSuite.com .",
...
'LBL_USER_ADDITION_INFO'=>"To add a new user, please click on  
			   <span style='font-style:italic;color:blue;'>OD-Settings Menu -> On Demand Admin -> Add User </span>",
